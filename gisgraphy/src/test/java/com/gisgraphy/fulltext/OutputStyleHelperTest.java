...
public class OutputStyleHelperTest {
	...
	assertEquals("The field list has a wrong size for MEDIUM :" + list, 46,
		list.split(",").length);
	...
	assertEquals("The field list has a wrong size for LONG :" + list, 54,
		list.split(",").length);
