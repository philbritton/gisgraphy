...
public class OutputStyleHelperTest {
	...
	assertEquals("The field list has a wrong size for MEDIUM :" + list, 45,
		list.split(",").length);
	...
	assertEquals("The field list has a wrong size for LONG :" + list, 53,
		list.split(",").length);
