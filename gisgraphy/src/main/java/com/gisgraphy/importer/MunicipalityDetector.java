	...
	public final static Map<String, MunicipalityOSMDetectionStrategy> countrycodeToCityOSMDetectionStrategy = new HashMap<String, MunicipalityDetector.MunicipalityOSMDetectionStrategy>(){
		{
			...
			put("AR",MunicipalityOSMDetectionStrategy.OSM);
			...
			put("FI",MunicipalityOSMDetectionStrategy.N);
			put("CA",MunicipalityOSMDetectionStrategy.ALL);
			put("MX",MunicipalityOSMDetectionStrategy.ALL);
			...
			put("CO",MunicipalityOSMDetectionStrategy.N_CITY_TOWN);
			put("PL",MunicipalityOSMDetectionStrategy.OSM);
			put("DZ",MunicipalityOSMDetectionStrategy.ALL);
			put("MA",MunicipalityOSMDetectionStrategy.OSM);
			put("PE",MunicipalityOSMDetectionStrategy.OSM);
			...
			put("SE",MunicipalityOSMDetectionStrategy.N_CITY_VILLAGE_TOWN);
