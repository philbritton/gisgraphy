...
function initUI(){
$('<form>').attr('id',this.formNodeID).attr('action',this.geocodingUrl).appendTo('#'+this.ELEMENT_ID);
if (this.withHelp){
        $("<img>").attr('alt','help').attr('src','./img/help.png').attr('onclick','gg.displayHelp();').addClass('help').appendTo('#'+this.formNodeID)
}
